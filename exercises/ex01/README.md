...
<details>
  ...
  2. Open the metadata extension ![package](images/adt_ddlx.png) **`ZC_BOOKING###`** and make the adjustments as shown in the code snippet below. ![package](images/adt_ddlx.png) **`ZC_BOOKING###`** should look like this: 
   > ℹ️ NOTE: The names of the artifacts, database fields, and other elements in your project may differ from those shown in this tutorial, as they are generated by GenAI
